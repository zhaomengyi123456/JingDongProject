...
import JingDongProject.JDLoginPage;
...
public class ReportUtils {
    ...
    private static Logger logger = Logger.getLogger(JDLoginPage.class.getName());
 ...
 *********************************************************************************************/
     ...
     *
     * @param comm
     * @comment 如果selenium.properties中【isPrintDebugMsg】值为0，则只打印logger，不打印report
     */
